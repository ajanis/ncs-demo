...
public class ietfDatastores extends ConfNamespace {
    public static final int hash = 1059869410;
    public int hash() {
        return ietfDatastores.hash;
    }

    public static final String id = "_cisco-nso-nc-5.7:cisco-nso-nc-5.7#urn:ietf:params:xml:ns:yang:ietf-datastores";
    public String id() {
        return ietfDatastores.id;
    }

    public static final String uri = "_cisco-nso-nc-5.7:cisco-nso-nc-5.7#urn:ietf:params:xml:ns:yang:ietf-datastores";
    public String uri() {
