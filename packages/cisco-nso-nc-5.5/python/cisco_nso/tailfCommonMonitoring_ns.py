...
class ns(object):
    ...
    id = "_cisco-nso-nc-5.5:cisco-nso-nc-5.5#http://tail-f.com/yang/common-monitoring"

    uri = "_cisco-nso-nc-5.5:cisco-nso-nc-5.5#http://tail-f.com/yang/common-monitoring"
