...
public class tailfCommonMonitoring extends ConfNamespace {
    public static final int hash = 267755639;
    public int hash() {
        return tailfCommonMonitoring.hash;
    }

    public static final String id = "_cisco-nso-nc-5.5:cisco-nso-nc-5.5#http://tail-f.com/yang/common-monitoring";
    public String id() {
        return tailfCommonMonitoring.id;
    }

    public static final String uri = "_cisco-nso-nc-5.5:cisco-nso-nc-5.5#http://tail-f.com/yang/common-monitoring";
    public String uri() {
