...
class ns(object):
    ...
    id = "_cisco-nso-nc-4.7:cisco-nso-nc-4.7#http://tail-f.com/yang/common-monitoring"

    uri = "_cisco-nso-nc-4.7:cisco-nso-nc-4.7#http://tail-f.com/yang/common-monitoring"
