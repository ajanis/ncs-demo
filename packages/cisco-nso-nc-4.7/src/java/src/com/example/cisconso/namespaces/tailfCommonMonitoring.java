...
public class tailfCommonMonitoring extends ConfNamespace {
    public static final int hash = 1271197515;
    public int hash() {
        return tailfCommonMonitoring.hash;
    }

    public static final String id = "_cisco-nso-nc-4.7:cisco-nso-nc-4.7#http://tail-f.com/yang/common-monitoring";
    public String id() {
        return tailfCommonMonitoring.id;
    }

    public static final String uri = "_cisco-nso-nc-4.7:cisco-nso-nc-4.7#http://tail-f.com/yang/common-monitoring";
    public String uri() {
