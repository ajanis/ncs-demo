...
public class IosxrNedCli extends NedCliBaseTemplate {
    ...
    public IosxrNedCli(String device_id,
        ...
        try {
            ...
            trace(worker, "NED VERSION: cisco-iosxr "+version_string+
                  " "+date_string, "out");
            ...
            String[] paths =
                {
                    ...
                    "/ncs:devices/ncs:profiles/profile{cisco-iosxr}/"+
                    "ncs:ned-settings",
        ...
        */
        try {
            ...
            if (msg.indexOf("No such configuration") >= 0) {
                ...
                throw new ExtendedApplyException(line, msg, e.isAtTop,
                                                 e.inConfigMode);
            }
        }
    }
