...
class ns(object):
    ...
    id = "_cisco-nso-nc-5.4:cisco-nso-nc-5.4#http://tail-f.com/yang/common-monitoring"

    uri = "_cisco-nso-nc-5.4:cisco-nso-nc-5.4#http://tail-f.com/yang/common-monitoring"
